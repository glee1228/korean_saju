...
자시(子時, 23:00–01:00)는 자정 경계를 가로지른다. 두 가지 처리 유파가 있다.

### 1. 야자시 분리법 (`yaja_si_separated=True`, **기본**)

한국 명리 표준. 23:00–24:00 = **야자시** — 일주는 **그날** 유지. 시주는 다음날 일간 기준으로 계산.

### 2. 정자시 단일·일자시 (`yaja_si_separated=False`)

중국 자평 유파에 가까운 처리. 23:00 이후 = 다음날로 간주. 일주가 **다음날**로 넘어감.
...
`yaja_si_separated` 차이는 **진태양시 23:00–24:00 출생자**에서만 발생한다.
...
| 야자시 | 夜子時 | 23:30~24:00 (당일 자시) |
| 조자시 | 朝子時 | 00:00~01:30 (다음날 자시) |
| 대운 | 大運 | 10년 단위 운세 흐름 |
| 세운 | 歲運 | 1년 단위 운세 |
